...
public class ExcecuteOnlyCommandFireBrigade2 extends AbstractOBFireBrigade {
	...
	public ExcecuteOnlyCommandFireBrigade2() {
		super();
	...
	protected void thinking2(int arg0, ChangeSet arg1, Collection<Command> arg2) {
		...
		if (this.task != null) {// タスクを受信
			...
			System.out.println(arg0 + ",receive:" + candidateSet);
		...
		if (this.targetBuilding != null) {
			this.extinguish(arg0, this.targetBuilding.getID(),
